...
using Abp.PlugIns;
using Boxfusion.Health.HealthCommon.Web.Core.Swagger;
...
using Boxfusion.Health.HealthCommon.Web.Host.Swagger;
        ...
        public void Configure(IApplicationBuilder app, IBackgroundJobClient backgroundJobs)
        {
            ...
            app.UseSwaggerUI(options =>
            {
                ...
                options.IndexStream = () => Assembly.GetExecutingAssembly()
                    .GetManifestResourceStream("Boxfusion.Health.HealthCommon.Web.Host.wwwroot.swagger.ui.index.html");
            }); // URL: /swagger
