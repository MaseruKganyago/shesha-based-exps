...
namespace Boxfusion.Health.HealthCommon.Core.Domain.BackBoneElements.Fhir
{
	...
	public class Dosage: FullAuditedEntity<Guid>
	{
		...
		/// 
		/// </summary>
		public virtual int? TimingRepeatCount { get; set; }
		/// <summary>
		/// 
		/// </summary>
		public virtual int? TimingRepeatCountMax { get; set; }
		/// <summary>
		/// 
		/// </summary>
		...
		/// 
		/// </summary>
		public virtual int? TimingRepeatFrequency { get; set; }
		/// <summary>
		/// 
		/// </summary>
		public virtual int? TimingRepeatFrequencyMax { get; set; }
		/// <summary>
		/// 
		/// </summary>
		...
		public virtual int? TimingRepeatOffSet { get; set; }
		/// <summary>
		/// 
		/// </summary>
