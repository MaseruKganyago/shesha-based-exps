...
{
    [Migration(20210610194900)]
    public class M20210610194900 : Migration
    {
        public override void Up()
        {
            var roles = new RoleInfos()
            {
                { "System Administrator", "HisAdmin", "Can access certain administrative functions required for the general monitoring and maintenance of the system (e.g. Log audit trails, Scheduled Jobs Maintenance, Notification templates)" },
            };
