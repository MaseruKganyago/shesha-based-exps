...
namespace Boxfusion.Health.His.Admissions.Authorization
{
    ...
    /// </summary>
    public class HisAdminPermissionChecker : ICustomPermissionChecker, IHisAdminPermissionChecker
    {
        ...
        /// Default constructor
        /// </summary>
        public HisAdminPermissionChecker(IRepository<Person, Guid> personRepository, IRepository<ShaRoleAppointedPerson, Guid> rolePersonRepository, IRepository<ShaRoleAppointmentEntity, Guid> appEntityRepository)
        {
