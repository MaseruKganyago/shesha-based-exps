...
namespace Boxfusion.Health.His.Domain.Migrations
{
    ...
    /// 
    /// </summary>
    [Migration(20220929115500)]
    public class M20220929115500 : Migration
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        {
            Execute.Sql(@"CREATE or ALTER     View [dbo].[vw_His_FlattenedHospitalAdmissions]
AS
select
hospAdm.Id,
...
hospAdm.ClassLkp,
hospAdm.His_HospitalAdmissionStatusLkp as HospitalAdmissionStatusLkp,
wardAdm.Id as WardAdmissionId,
ward.Name as WardName,
wardAdm.His_WardAdmissionStatusLkp as WardAdmissionStatusLkp,
...
iif(hospAdm.His_HospitalAdmissionStatusLkp != 1, DATEDIFF(day, hospAdm.StartDateTime, hospAdm.EndDateTime), DATEDIFF(day, hospAdm.StartDateTime, DateAdd(hour, 2, GETUTCDATE()))) as LOS
from Fhir_Encounters hospAdm
	...
	left join Fhir_Encounters wardAdm on wardAdm.PartOfId = hospAdm.Id 
	...
	left join Fhir_Coverages cov on cov.BeneficiaryId = patient.Id
	left join Core_Organisations org on org.Id = cov.PayorOrganisationId
