...
namespace Boxfusion.Health.HealthCommon.Core.Migrations
{
    ...
    /// 
    /// </summary>
    [Migration(20211111140200)]
    public class M20211111140200 : Migration
    {
        /// <summary>
        /// 
        /// </summary>
        public override void Up()
        {
            Execute.Sql(@"
                ...
                iif(patient.HisAdmis_AdmissionStatusLkp = 1, DATEDIFF(day,encounter.StartDateTime, getdate()), DATEDIFF(day,encounter.StartDateTime, encounter.EndDateTime)) as days
