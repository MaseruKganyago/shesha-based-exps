...
namespace Boxfusion.Health.Domain.Authorization
{
    ...
    /// </summary>
    public class HealthDomainPermissionChecker : ICustomPermissionChecker, IHealthDomainPermissionChecker
    {
        ...
        /// Default constructor
        /// </summary>
        public HealthDomainPermissionChecker(IRepository<Person, Guid> personRepository, IRepository<ShaRoleAppointedPerson, Guid> rolePersonRepository, IRepository<ShaRoleAppointmentEntity, Guid> appEntityRepository)
        {
