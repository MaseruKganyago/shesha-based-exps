...
{
    /// <summary>
    /// Concepts representing classification of patient encounter such as ambulatory (outpatient), inpatient, emergency, home health or others 
    /// due to local variations.
    /// </summary>
    [Entity(TypeShortAlias = "HealthDomain.EncounterClass")]
    public class EncounterClass : FullAuditedEntity<Guid>
    {
        /// <summary>
