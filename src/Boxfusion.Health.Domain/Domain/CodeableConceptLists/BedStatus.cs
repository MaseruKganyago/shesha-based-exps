...
{
    /// <summary>
    /// The operational status covers operation values most relevant to beds (but can also apply to rooms/units/chairs/etc. such as 
    /// an isolation unit/dialysis chair). This typically covers concepts such as contamination, housekeeping, and other activities 
    /// like maintenance.
    /// </summary>
    [Entity(TypeShortAlias = "HealthDomain.BedStatus")]
    public class BedStatus : FullAuditedEntity<Guid>
    {
        /// <summary>
