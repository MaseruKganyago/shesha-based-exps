...
using Boxfusion.Health.His.Admissions.Services.HisPatients.Dtos;
using Boxfusion.Health.His.Admissions.Services.HisPatients.Helpers;
...
namespace Boxfusion.Health.His.Admissions.Services.HisPatients
{
    /// <summary>
    /// 
    /// </summary>
