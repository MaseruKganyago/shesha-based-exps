    ...
    public class AdmissionMapProfile : ShaProfile
    {
        ...
        public AdmissionMapProfile()
        {
            ...
            CreateMap<WardAdmission, AdmissionResponse>()
                ...
                .ForMember(c => c.SeparationDestinationWard, options => options.MapFrom(c => c.SeparationDestinationWard != null ? new EntityWithDisplayNameDto<Guid?>(c.SeparationDestinationWard.Id, c.Identifier) : null))
