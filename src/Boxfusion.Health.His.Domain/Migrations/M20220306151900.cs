...
namespace Boxfusion.Health.His.Domain.Migrations
{
    ...
    public class M20220306151900 : Migration
    {
        ...
        public override void Up()
        {
            ...
            Execute.Sql(@"
                CREATE OR ALTER FUNCTION[dbo].[fn_His_GetFacilityPatientIdentifier] (@patientId uniqueidentifier, @facilityId uniqueidentifier)
                    RETURNS nvarchar(100)
                AS
                BEGIN
                    DECLARE @facilityIdentifier nvarchar(100);

                            SELECT @facilityIdentifier = [Value]

                    FROM Fhir_Identifiers

                    WHERE
                        AssignerId = @facilityId
            ...
            Execute.Sql(@"
	            CREATE OR ALTER VIEW [dbo].[vw_His_FlattenedFacilityPatients]
	            AS
	            SELECT 
                   p.Id
                   ,[TitleLkp]
                  ...
                  ,[His_IdentificationTypeLkp] [IdentificationTypeLkp]
