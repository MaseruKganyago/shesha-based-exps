...
namespace Boxfusion.Health.His.Domain.Authorization
{
    ...
    /// </summary>
    public class HisDomainPermissionChecker : ICustomPermissionChecker, IHisDomainPermissionChecker
    {
        ...
        /// Default constructor
        /// </summary>
        public HisDomainPermissionChecker(IRepository<Person, Guid> personRepository, IRepository<ShaRoleAppointedPerson, Guid> rolePersonRepository, IRepository<ShaRoleAppointmentEntity, Guid> appEntityRepository)
        {
