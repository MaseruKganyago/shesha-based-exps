...
namespace Boxfusion.Smartgov.Epm.Domain.Components
{
    ...
    public class Component : FullAuditedEntity<Guid>
    {
        ...
        /// 
        /// </summary>
        public virtual float? OrderIndex { get; set; }
        ...
        /// 
        /// </summary>
        public virtual float? LatestPerfIndex { get; set; }
        ...
        /// 
        /// </summary>
        public virtual float? RAGGreenThreshold { get; set; }

        /// <summary>
        /// 
        /// </summary>
        public virtual float? RAGRedThershold { get; set; }
        ...
        /// 
        /// </summary>
        public virtual float? FinalIndicatorTarget { get; set; }

        /// <summary>
        /// 
        /// </summary>
        public virtual float? LatestIndicatorValue { get; set; }
