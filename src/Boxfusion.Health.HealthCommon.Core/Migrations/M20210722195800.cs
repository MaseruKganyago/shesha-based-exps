    ...
    public class M20210722195800 : Migration
    {
        public override void Up()
        {
            ...
            Alter.Table("Core_Facilities")
                .AddColumn("Fhir_StatusLkp").AsInt32().Nullable()
                .AddColumn("Fhir_OperationalStatusLkp").AsInt32().Nullable()
                .AddColumn("Fhir_Alias").AsString().Nullable()
                .AddColumn("Fhir_ModeLkp").AsInt32().Nullable()
                ...
                .AddColumn("Fhir_PhysicalTypeLkp").AsInt32().Nullable()
