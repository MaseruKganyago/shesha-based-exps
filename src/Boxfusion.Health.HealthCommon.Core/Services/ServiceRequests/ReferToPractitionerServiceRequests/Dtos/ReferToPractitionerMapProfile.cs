...
namespace Boxfusion.Health.HealthCommon.Core.Services.ServiceRequests.ReferToPractitionerServiceRequests.Dtos
{
    /// <summary>
    /// 
    /// </summary>
    public class ReferToPractitionerMapProfile: ShaProfile
    {
        /// <summary>
        /// 
        /// </summary>
        public ReferToPractitionerMapProfile()
        {
            CreateMap<ReferToPractitionerServiceRequestInput, ReferToPractitionerServiceRequest>()
            ...
            //CreateMap<ReferToPractitionerServiceRequestUpdate, ReferralServiceRequest>()
            //    .ForMember(e => e.Replaces, e => e.MapFrom(e => GetEntity<ServiceRequest>(e.Replaces)))
            //    .ForMember(e => e.Subject, e => e.MapFrom(e => GetEntity<Patient>(e.Subject)))
            //    .ForMember(e => e.Encounter, e => e.MapFrom(e => GetEntity<Encounter>(e.Encounter)))
            //    .ForMember(e => e.ServiceQueue, e => e.MapFrom(e => GetEntity<Schedule>(e.ServiceQueue)))
            ...
            CreateMap<ReferToPractitionerServiceRequest, ReferToPractitionerServiceRequestResponse>()
            ...
            CreateMap<Person, ReferToPractitionerServiceRequestInput>()
            ...
            CreateMap<Person, ReferToPractitionerServiceRequestUpdate>()
                .ForMember(c => c.Id, options => options.Ignore())
                .ForMember(c => c.PerformerOwnerId, options => options.MapFrom(c => c != null ? c.Id.ToString() : null))
                .ForMember(c => c.PerformerOwnerType, options => options.MapFrom(c => c != null ? c.GetTypeShortAlias() : null));
        }
