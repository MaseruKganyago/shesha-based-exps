...
namespace Boxfusion.Health.HealthCommon.Core.Services.ServiceRequests.AmbulanceServiceRequests.Dtos
{
    /// <summary>
    /// 
    /// </summary>
	public class AmbulanceServiceRequestMapProfile: ShaProfile
	{
        /// <summary>
        /// 
        /// </summary>
		public AmbulanceServiceRequestMapProfile()
		{
            //Cdm's mappings
            CreateMap<AmbulanceServiceRequestInput, AmbulanceServiceRequest>()
            ...
            CreateMap<AmbulanceServiceRequest, AmbulanceServiceRequestResponse>()
            ...
            //Address
            CreateMap<CdmAddressInput, FhirAddress>()
                .ForMember(u => u.Use, options => options.Ignore())
                .ForMember(u => u.Type, options => options.Ignore())
                .MapReferenceListValuesFromDto();

            CreateMap<FhirAddress, CdmAddressResponse>()
                .ForMember(u => u.Use, options => options.Ignore())
                .ForMember(u => u.Type, options => options.Ignore())
                .MapReferenceListValuesFromDto();

            CreateMap<Person, AmbulanceServiceRequestInput>()
