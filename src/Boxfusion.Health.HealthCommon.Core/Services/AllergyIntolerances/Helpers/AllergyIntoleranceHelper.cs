...
namespace Boxfusion.Health.HealthCommon.Core.Services.AllergyIntolerances.Helpers
{
    ...
    public class AllergyIntoleranceHelper: SheshaAppServiceBase, IAllergyIntoleranceHelper, ITransientDependency
    {
        ...
        /// 
        /// </summary>
        public AllergyIntoleranceHelper(IUnitOfWorkManager unitOfWorkManager,
