    ...
    public class AppointmentForBookingManager_Test : BookingManagementTestBase
    {
        ...
        public async Task Should_be_able_to_book_and_exhaust_capacity()
        {
            ...
            try
            {
                ...
                using (var uow = _uowManager.Begin())
                {
                    var avaialbleSlots = await _bookingManager.GetAllAvailableBookingSlotsAsync(schedule, RefListSlotCapacityTypes.Regular, DateTime.Now.Date.AddDays(1), DateTime.Now.Date.AddDays(2));

                    // Confirming have expected capacity
                    var slot = avaialbleSlots.Find(e => e.StartDateTime == bookingTime && e.CapacityType == RefListSlotCapacityTypes.Regular);
                    ...
                    var app1 = await _bookingManager.BookAvailableSlotAsync(schedule.Id, RefListSlotCapacityTypes.Regular, bookingTime, null, patient, "", "");
                    var app2 = await _bookingManager.BookAvailableSlotAsync(schedule.Id, RefListSlotCapacityTypes.Regular, bookingTime, null, patient, "", "");
                ...
                using (var uow = _uowManager.Begin())
                {
                    ...
                    var app3 = await _bookingManager.BookAvailableSlotAsync(schedule.Id, RefListSlotCapacityTypes.Regular, bookingTime, null, patient, "", "");
                    await uow.CompleteAsync();
                }
                ...
                using (var uow = _uowManager.Begin())
                {
                    ...
                    {
                        await _bookingManager.BookAvailableSlotAsync(schedule.Id, RefListSlotCapacityTypes.Regular, bookingTime, null, patient, "", "");
                    });
        ...
        public async Task Should_not_be_able_to_book_Regular_Slot_When_only_Overflow_capacity_is_available()
        {
            ...
            try
            {
                ...
                using (var uow = _uowManager.Begin())
                {
                    ...
                    app1 = await _bookingManager.BookAvailableSlotAsync(schedule.Id, RefListSlotCapacityTypes.Overflow, bookingTime, null, patient, "", "");
                    await uow.CompleteAsync();
                }

                using (var uow = _uowManager.Begin())
                {
                    var app2 = await _bookingManager.BookAvailableSlotAsync(schedule.Id, RefListSlotCapacityTypes.Overflow, bookingTime, null, patient, "", "");
        ...
        public async Task Should_be_able_to_Cancel_appointment_and_release_capacity()
        {
            ...
            try
            {
                ...
                {
                    // Book an appointment
                    app = await _bookingManager.BookAvailableSlotAsync(schedule.Id, RefListSlotCapacityTypes.Regular, bookingTime, null, patient, "", "");
                    await uow.CompleteAsync();
        ...
        public async Task Should_be_able_to_Reschedule_appointment_ensure_release_capacity()
        {
            ...
            try
            {
                ...
                using (var uow = _uowManager.Begin())
                {
                    ...
                    newApp = await _bookingManager.RescheduleAppointment(app.Id, RefListSlotCapacityTypes.Regular, newBookingTime, "", "");
