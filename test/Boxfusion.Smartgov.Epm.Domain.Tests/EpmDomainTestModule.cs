...
using Boxfusion.Smartgov.Epm.Tests.DependencyInjection;
...
namespace Boxfusion.Smartgov.Epm.Tests
{
	...
	public class EpmDomainTestModule: AbpModule
	{
		...
		public EpmDomainTestModule(SheshaNHibernateModule nhModule)
		{
